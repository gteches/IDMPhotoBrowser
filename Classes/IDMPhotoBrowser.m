...
//    NSBundle *bundle = [NSBundle bundleWithURL:[[NSBundle mainBundle] URLForResource:@"IDMPhotoBrowser" withExtension:@"bundle"]];
    NSURL *url = [[NSBundle bundleForClass:self.class] URLForResource:@"IDMPhotoBrowser" withExtension:@"bundle"];
    url = [url URLByAppendingPathComponent:@"images"];
    NSURL *saveURL = [url URLByAppendingPathComponent:@"IDMPhotoBrowser_save"];
    saveURL = [saveURL URLByAppendingPathExtension:@"png"];
    UIImage *saveButtonImage = [UIImage imageWithContentsOfFile:saveURL.path];

    NSURL *leftURL = [url URLByAppendingPathComponent:@"IDMPhotoBrowser_arrowLeft"];
    leftURL = [leftURL URLByAppendingPathExtension:@"png"];
    
    UIImage *leftButtonImage = (_leftArrowImage == nil) ?
    [UIImage imageWithContentsOfFile:leftURL.path]          : _leftArrowImage;
    
    NSURL *rightURL = [url URLByAppendingPathComponent:@"IDMPhotoBrowser_arrowRight"];
    rightURL = [rightURL URLByAppendingPathExtension:@"png"];

    UIImage *rightButtonImage = (_rightArrowImage == nil) ?
    [UIImage imageWithContentsOfFile:rightURL.path]         : _rightArrowImage;
    
    NSURL *leftSelectedURL = [url URLByAppendingPathComponent:@"IDMPhotoBrowser_arrowLeftSelected"];
    leftSelectedURL = [leftSelectedURL URLByAppendingPathExtension:@"png"];

    UIImage *leftButtonSelectedImage = (_leftArrowSelectedImage == nil) ?
    [UIImage imageWithContentsOfFile:leftSelectedURL.path]  : _leftArrowSelectedImage;
    
    NSURL *rightSelectedURL = [url URLByAppendingPathComponent:@"IDMPhotoBrowser_arrowLeftSelected"];
    rightSelectedURL = [rightSelectedURL URLByAppendingPathExtension:@"png"];

    UIImage *rightButtonSelectedImage = (_rightArrowSelectedImage == nil) ?
    [UIImage imageWithContentsOfFile:rightSelectedURL.path] : _rightArrowSelectedImage;
